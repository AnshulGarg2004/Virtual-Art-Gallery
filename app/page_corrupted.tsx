    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
        ...
        <div className="lg:col-span-6">
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900/50 via-purple-900/30 to-slate-900/50 p-6 backdrop-blur-xl shadow-2xl">
            <Carousel
            ...
            >
              <CarouselContent>
                {filteredList.map((art, index) => {
                  ...
                  return (
                    <CarouselItem key={art.id} className="md:basis-full">
                      <motion.div
                      ...
                      >
                        <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                            <span className="inline-block rounded-full bg-gradient-to-r from-violet-500/90 to-fuchsia-500/90 px-3 py-1 text-xs font-semibold text-white mb-2">
                              {art.year}
                            </span>
                            <h3 className="text-2xl font-bold text-white mb-1">{art.title}</h3>
                            <p className="text-sm text-slate-300">{art.artist}</p>
                          </div>

                          {isActive && (
                            <button
                              onClick={() => openModal(art)}
                              className="absolute top-4 right-4 rounded-full border border-white/30 bg-black/50 p-3 text-white backdrop-blur-md transition-all hover:bg-black/70 hover:scale-110"
                            >
              ...
              <CarouselPrevious className="left-2 bg-black/50 border-white/20 text-white backdrop-blur-md hover:bg-black/70" />
              <CarouselNext className="right-2 bg-black/50 border-white/20 text-white backdrop-blur-md hover:bg-black/70" />
            </Carousel>

            <div className="mt-6 flex items-center justify-center gap-2">
              {filteredList.slice(Math.max(0, currentIndex - 2), currentIndex + 3).map((_, idx) => {
        ...
        <div className="lg:col-span-3 space-y-4">
          <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 via-purple-900/50 to-slate-900/90 p-4 backdrop-blur-xl">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-3">Search & Filter</h3>
            
            <div className="space-y-3">
            <button
              onClick={() => goTo(currentIndex - 1)}
              className="group flex items-center justify-center gap-2 rounded-2xl border border-white/20 bg-gradient-to-r from-purple-500/20 to-pink-500/20 py-3 text-sm font-semibold text-white transition-all duration-300 hover:border-purple-400/50 hover:from-purple-500/30 hover:to-pink-500/30 hover:shadow-lg hover:shadow-purple-500/30 active:scale-95"
            >
        ...
        <div>
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            <button
              onClick={handleShuffle}
              className="group flex items-center justify-center gap-2 rounded-2xl border border-pink-500/40 bg-gradient-to-r from-pink-500/40 to-purple-500/40 py-3 text-sm font-semibold text-white transition-all duration-300 hover:from-pink-500/60 hover:to-purple-500/60 hover:shadow-xl hover:shadow-pink-500/40 hover:scale-105 active:scale-95"
            >
              <Shuffle className="h-4 w-4 group-hover:rotate-180 transition-transform duration-500" />
              Surprise
            </button>
            <button
              onClick={() => openModal(currentArtwork)}
              className="group flex items-center justify-center gap-2 rounded-2xl border border-sky-500/40 bg-gradient-to-r from-sky-500/30 to-blue-500/30 py-3 text-sm font-semibold text-white transition-all duration-300 hover:border-sky-400/50 hover:from-sky-500/50 hover:to-blue-500/50 hover:shadow-xl hover:shadow-sky-500/40 hover:scale-105 active:scale-95"
            >
        ...
        <div className="space-y-2 rounded-xl border border-white/10 bg-white/5 p-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex h-8 w-8 items-center justify-center rounded-lg border text-white transition ${
                isAutoRotate
                  ? "border-sky-400/50 bg-sky-500/20"
                  : "border-white/10 bg-white/5 hover:border-white/40 hover:bg-white/20"
              }`}
            >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 py-2 text-sm text-white/80 transition hover:border-white/30 hover:bg-white/10"
          >
        ...
        <p className="text-xs text-white/60">
          Use your arrow keys or swipe left & right to explore the space.
        </p>
      </div>
    </>
  );
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-gradient-to-br from-violet-500/30 via-fuchsia-500/20 to-transparent blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 90, 0],
          }}
        ...
        />
        <motion.div
          className="absolute top-1/4 -left-40 h-96 w-96 rounded-full bg-gradient-to-br from-cyan-500/30 via-blue-500/20 to-transparent blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            rotate: [90, 0, 90],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-0 left-1/2 h-96 w-96 rounded-full bg-gradient-to-br from-pink-500/30 via-rose-500/20 to-transparent blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            x: [-50, 50, -50],
          }}
      ...
      {/* Header Bar */}
      <header className="relative z-20 border-b border-white/10 bg-gradient-to-r from-slate-900/80 via-purple-900/60 to-slate-900/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            <div className="relative">
              <div className="absolute inset-0 animate-pulse rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 blur-xl opacity-50" />
              <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-600 via-fuchsia-600 to-cyan-600 shadow-2xl">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Curated Visual Experience</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white transition-all hover:bg-white/10 hover:border-violet-500/50"
            >
              {isMusicOn ? <Pause className="h-4 w-4" /> : <Play className="h-4 w-4" />}
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-xl border px-4 py-2 text-sm font-medium transition-all ${
                isAutoRotate
                  ? "border-violet-500/50 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 text-white"
      ...
      <main className="relative z-10 mx-auto w-full max-w-7xl px-6 py-8">
        ...
        <section className="flex w-full flex-col gap-6 lg:flex-1 lg:min-w-0 mt-6">
            ...
            >
              ...
              <div className="grid gap-4 sm:gap-6 lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="grid gap-2 sm:gap-3 sm:grid-cols-3 mt-4">
                    <button
                      onClick={() => modalArtwork && downloadArtwork(modalArtwork)}
                    ...
                    <button
                      onClick={() => modalArtwork && shareArtwork(modalArtwork)}
      ...
      />
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-base font-semibold">Explore the catalog</h2>
            </div>
          </div>
              ...
              <div className="flex items-center gap-2 rounded-xl border border-purple-500/30 bg-gradient-to-r from-purple-900/40 to-pink-900/40 px-3 py-2 shadow-lg shadow-purple-500/20 focus-within:border-purple-400/60 focus-within:shadow-purple-500/30 transition-all duration-300">
                ...
                {searchTerm && (
                  <button
                    ...
                    className="text-xs text-purple-300/70 transition hover:text-pink-300 font-medium"
                  >
                    Clear
                  </button>
                )}
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-3">
            ...
            <div className="mt-2 grid grid-cols-7 gap-1.5 text-[10px] text-white/70">
              {alphabet.map((letter) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-lg border px-1.5 py-0.5 transition-all duration-300 font-semibold ${
                      letterFilter === letter
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-3">
            <p className="flex items-center gap-1.5 text-[10px] uppercase tracking-[0.35em] text-white/60">
            ...
            <div className="mt-2 flex flex-wrap gap-1.5">
              <button
                ...
                className={`rounded-full px-3 py-1 text-[10px] transition-all duration-300 font-semibold ${
                  yearFilter === null
          ...
          <div className="flex flex-col gap-2 rounded-xl border border-white/10 bg-white/5 p-3">
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div className="rounded-xl border border-white/10 bg-black/20 p-2">
                ...
                <p className="text-[9px] text-white/60">Artworks</p>
              </div>
              <div className="rounded-xl border border-white/10 bg-black/20 p-2">
                <p className="text-lg font-semibold">{stats.artists}</p>
                <p className="text-[9px] text-white/60">Artists</p>
              </div>
              <div className="rounded-xl border border-white/10 bg-black/20 p-2">
                <p className="text-sm font-semibold">{stats.range}</p>
                <p className="text-[9px] text-white/60">Year range</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-3">
            <div className="flex items-center justify-between text-[10px] text-white/70">
              <p>{filteredList.length} curated pieces</p>
              <p>Tap to focus</p>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col">
                      <p className="font-medium text-white text-xs">{art.title}</p>
